...
//		SHADER_PARAMETER(UINT, THREADGROUPSIZE_X)
//		SHADER_PARAMETER(UINT, THREADGROUPSIZE_Y)
//		SHADER_PARAMETER(UINT, THREADGROUPSIZE_Z)
//	END_SHADER_PARAMETER_STRUCT()
//
//	//Called by engine to deteremin how to compile for this shader
...
//IMPLEMENT_GLOBAL_SHADER(FCloudShader, "/CustomShaders/CloudShader.usf", "MainComputeShader", SF_Compute);
//
////Static members
...
//		FPooledRenderTargetDesc ComputeShaderOutputDesc(FPooledRenderTargetDesc::Create2DDesc(cachedParams.GetRenderTargetSize(), cachedParams.RenderTarget->GetRenderTargetResource()->TextureRHI->GetFormat(),
...
//	PassParamaters.Dimensions = FVector2D(cachedParams.GetRenderTargetSize().X, cachedParams.GetRenderTargetSize().Y);
